...
def initialize_arm():
    ...
    arm_hostname = "evacunningyorkartistpt410" # "evatrendylimashifterpt410"
    arm_ip = "144.32.152.2" # "144.32.152.105"
    token = "4b1c26278a566e0419165a3acd025dd83d32b160" # "1462980d67d58cb7eaabe8790d866609eb97fd2c"
...
def main():
    ...
    try:     
        ...
        shift_end_efector(kn, eva, pick_up_position);
        ...
        move_end_efector(kn, eva, target_drop_location);
...
def test_x_axis(kn, eva):
    print("Testing X axis increments...");

    for x in range(6):
        target_position = [0.01, 0, 0]
